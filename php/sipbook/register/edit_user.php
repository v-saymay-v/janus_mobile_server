...
echo"</tabel></font>";
			...
			?>
                  ...
                  <table width='49%' border='0' align="center" cellpadding='10' cellspacing='0'>
                    <tr>
                      ...
                      <td width='342' bgcolor="#ebebeb"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
                       <?php echo $id; ?><input type="hidden" width="50" name="id" value = '<?php echo $id; ?>' /> </font></td>
                    </tr>
                    <tr>
                  ...
                  <p>&nbsp;</p>
                  <p><a href="delete_user_confirm.php?id=<?php echo $id; ?>"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Delete User </font></a></p>
              </div></td>
            </tr>
          </table>
          <p>
