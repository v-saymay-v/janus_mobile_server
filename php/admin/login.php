...
//if ($response != null && $response->success) {
		...
		{
			$userdetails = fetchUserDetails($mysqli, $username);
			...
			else
			{
				...
				else
				{
					...
					$loggedInUser->homepage = $userdetails["url"];
					$loggedInUser->user_id = $userdetails["id"];
					$loggedInUser->company_id = $userdetails["company_id"];
					$loggedInUser->hash_pw = $userdetails["password"];
					$loggedInUser->title = $userdetails["title"];
					$loggedInUser->displayname = $userdetails["display_name"];
					$loggedInUser->companyname = $userdetails["company_name"];
					$loggedInUser->username = $userdetails["user_name"];
					$loggedInUser->dateformat = $userdetails["date_format"];
...
?>
					...
					<form name="login" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
						...
						<p>
						<label><?php echo $lang["LOGIN_PHP_USERNAME"] ?>:</label>
						<input  class='form-control' type='text' name='username' />
						</p>

						<p>
						<label><? echo $lang["LOGIN_PHP_PASSWORD"] ?>:</label>
