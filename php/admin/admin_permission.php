  ...
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header">
        <?php echo $lang["ADMIN_PERMISSION_PHP_ADMIN_PERMISSIONS"] ?>
      </h1>
      <!-- CONTENT GOES HERE -->
      ...
      <table class='table'>
      <tr><td>
        <h3><?php echo $lang["ADMIN_PERMISSION_PHP_PERMISSION_INFORMATION"] ?></h3>
        <div id='regbox'>
          <p>
            <label>ID:</label>
          ...
          <p>
            <label><?php echo $lang["ADMIN_PERMISSION_PHP_NAME"] ?>:</label>
            <input type='text' name='name' value='<?php echo $permissionDetails['name'] ?>' />
          </p>
          <p>
            <label><?php echo $lang["ADMIN_PERMISSION_PHP_DELETE"] ?>:</label>
        ...
        <h3><?php echo $lang["ADMIN_PERMISSION_PHP_PERMISSION_MEMBERSHIP"] ?></h3>
        <div id='regbox'>
          <p><?php echo $lang["ADMIN_PERMISSION_PHP_REMOVE_MEMBERS"] ?>:
          <?php
          ...
          <p><?php echo $lang["ADMIN_PERMISSION_PHP_ADD_MEMBERS"] ?>:
          <?php
      ...
      <td>
        <h3><?php echo $lang["ADMIN_PERMISSION_PHP_PERMISSION_ACCESS"] ?></h3>
        <div id='regbox'>
          <p><?php echo $lang["ADMIN_PERMISSION_PHP_PUBLIC_ACCESS"] ?>:
          <?php
          //List public pages
          ...
          <p><?php echo $lang["ADMIN_PERMISSION_PHP_REMOVE_ACCESS"] ?>:
          <?php
          ...
          <p><?php echo $lang["ADMIN_PERMISSION_PHP_ADD_ACCESS"] ?>:
          <?php
