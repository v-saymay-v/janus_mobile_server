...
$lang = array_merge($lang,array(
	...
	"ACCOUNT_DIVISION_UPDATED"			=> "%m1%'s division changed to %m2%",
	...
	"ACCOUNT_DEPART_UPDATED" => "Department name updated"
	));
...
$lang = array_merge($lang,array(
	"ACTIVATE_ACCOUNT_PHP_ACTIVATE_ACCOUNT" => "Activate Account"
));

//admin-configration.php
$lang = array_merge($lang,array(
	"ADMIN_CONFINGRATION_PHP_WEBSITE_NAME" => "Website Name",
	"ADMIN_CONFINGRATION_PHP_WEBSITE_URL" => "Website URL",
	"ADMIN_CONFINGRATION_PHP_EMAIL" => "Email",
	"ADMIN_CONFINGRATION_PHP_ACTIVATION_THRESHOLD" => "Activation Threshold",
	"ADMIN_CONFINGRATION_PHP_LANGUAGE" => "Language",
	"ADMIN_CONFINGRATION_PHP_EMAIL_ACTIVATION" => "Email Activation",
	"ADMIN_CONFINGRATION_PHP_SHOW_OTHERS" => "Show Other's Cards",
	"ADMIN_CONFINGRATION_PHP_TEMPLATE" => "Template",
));
...
//admin-pages.php
$lang = array_merge($lang,array(
	"ADMIN_PAGE_PHP_ADMIN_PAGES" => "Admin Pages",
));
...
//admin-user.php
$lang = array_merge($lang,array(
	"ADMIN_USER_PHP_USER_INFORMATION" => "User Information",
	"ADMIN_USER_PHP_USERNAME" => "Username",
	"ADMIN_USER_PHP_EMAIL" => "Email",
	"ADMIN_USER_PHP_PASSWORD" => "Password",
	"ADMIN_USER_PHP_PASSWORD_CONFIRM" => "Password(confirm)",
	"ADMIN_USER_PHP_DISPLAY_NAME" => "Display Name",
	"ADMIN_USER_PHP_ACTIVE" => "Active",
	"ADMIN_USER_PHP_ACTIVATE" => "Activate",
	"ADMIN_USER_PHP_AUTHORITY" => "Priority",
	"ADMIN_USER_PHP_DIVISION" => "Division",
	"ADMIN_USER_PHP_TITLE" => "Title",
	"ADMIN_USER_PHP_SIGN_UP" => "Sign Up",
	"ADMIN_USER_PHP_LAST_SIGN_IN" => "Last Sign In",
	"ADMIN_USER_PHP_ADD" => "Add",
	"ADMIN_USER_PHP_DELETE" => "Delete",
	"ADMIN_USER_PHP_UPDATE" => "Update"
));


//admin-users.php
$lang = array_merge($lang,array(
	"ADMIN_USERS_PHP_ADMIN_USERS" => "Admin Users",
	"ADMIN_USERS_PHP_DELETE" => "Delete",
	"ADMIN_USERS_PHP_USERNAME" => "Username",
	"ADMIN_USERS_PHP_DISPLAY_NAME" => "Display Name",
	"ADMIN_USERS_PHP_TITLE" => "Title",
	"ADMIN_USERS_PHP_LAST_SIGN_IN" => "Last Sign In",
));

//admin-depart.php
$lang = array_merge($lang,array(
	"ADMIN_DEPART_PHP_DEPART_INFORMATION" => "Department Information",
	"ADMIN_DEPART_PHP_NAME" => "Name",
	"ADMIN_DEPART_PHP_YOMI" => "Pronous",
	"ADMIN_DEPART_PHP_DELETE" => "Delete",
	"ADMIN_DEPART_PHP_UPDATE" => "Update",
	"ADMIN_DEPART_PHP_ADD" => "Add"
));

//admin-departs.php
$lang = array_merge($lang,array(
	"ADMIN_DEPARTS_PHP_ADMIN_DEPARTS" => "Admin Departments",
	"ADMIN_DEPARTS_PHP_DELETE" => "Delete",
	"ADMIN_DEPARTS_PHP_NAME" => "Name",
	"ADMIN_DEPARTS_PHP_YOMI" => "Pronous",
	"ADMIN_DEPARTS_PHP_ADD" => "Add"
));

//blank-page.php
$lang = array_merge($lang,array(
	"BLANK_PAGE_PHP_BLANK_PAGE" => "Blank Page",
	"BLANK_PAGE_PHP_SUBHEADING" => "Subheading"
));

//forgot-password.php
$lang = array_merge($lang,array(
	"FORGOT_PASSWORD_PHP_FORGOT_PASSWORD" => "Forgot Password",
	"FORGOT_PASSWORD_PHP_EMAIL" => "Email",
));

//login.php
$lang = array_merge($lang,array(
	"LOGIN_PHP_LOGIN" => "Login",
	"LOGIN_PHP_USERNAME" => "Username",
	"LOGIN_PHP_PASSWORD" => "Password"
));

//resend-activation.php
$lang = array_merge($lang,array(
	"RESEND_ACTIVATION_PHP_RESEND_ACTIVATION" => "Resend Activation",
	"RESEND_ACTIVATION_PHP_EMAIL" => "Email"
));

//user-settings.php
$lang = array_merge($lang,array(
	"USER_SETTINGS_PHP_USER_SETTINGS" => "User Settings",
	"USER_SETTINGS_PHP_PASSWORD" => "Password",
	"USER_SETTINGS_PHP_EMAIL" => "Email",
	"USER_SETTINGS_PHP_NEW_PASSWORD" => "New Password (8 character minimum)",
	"USER_SETTINGS_PHP_CONFIRM_PASSWORD" => "Confirm Password"
));

//left-nav.php
$lang = array_merge($lang,array(
	"LEFT_NAV_PHP_ACCOUNT_HOME" => "Account Home",
	"LEFT_NAV_PHP_USER_SETTING" => "User Settings",
	"LEFT_NAV_PHP_ADMIN_CONFIGURATION" => "Admin Configuration",
	"LEFT_NAV_PHP_ADMIN_DEPARTS" => "Admin Departments",
	"LEFT_NAV_PHP_ADMIN_USERS" => "Admin Users",
	"LEFT_NAV_PHP_LOGOUT" => "Logout",
	"LEFT_NAV_PHP_FORGOT_PASSWORD" => "Forgot Password",
	"LEFT_NAV_PHP_RESEND_ACTIVATION_EMAIL" => "Resend Activation Email"
));

//top-nav.php
$lang = array_merge($lang,array(
	"TOP_NAV_PHP_APP_NAME" => "UserSpice 2.5.6",
	"TOP_NAV_PHP_ACCOUNT_INFO" => "Account Info",
	"TOP_NAV_PHP_SIGN_OUT" => "Sign Out",
	"TOP_NAV_PHP_SIGN_IN" => "Sign In",
));
?>
