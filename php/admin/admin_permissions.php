  ...
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header">
        <?php echo $list["ADMIN_PERMISSIONS_PHP_ADMIN_PERMISSIONS"] ?>
      </h1>
      <!-- CONTENT GOES HERE -->
      ...
      <tr>
      <th><?php echo $lang["ADMIN_PERMISSIONS_PHP_DELETE"] ?></th><th><?php echo $lang["ADMIN_PERMISSIONS_PHP_PERMISSION_NAME"] ?></th>
      </tr>
      ...
      <p>
      <label><?php echo $lang["ADMIN_PERMISSIONS_PHP_PERMISSION_NAME"] ?>:</label>
